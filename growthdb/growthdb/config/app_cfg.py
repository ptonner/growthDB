# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in growthdb.
...
import growthdb
from growthdb import model, lib
...
base_config.model = growthdb.model
base_config.DBSession = growthdb.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "b9520ebe-e04c-4c6b-a6b0-38ea98f4daa8"
